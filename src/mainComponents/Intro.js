const Intro = () => {
	return (
		<section className="text-left">
			<p className="blue-text">Hi there! My name is</p>
			<h1 className="primary-text">Jerry Safter-Brown.</h1>
			<h1 className="secondary-text">I'm a Frontend Software Engineer.</h1>
